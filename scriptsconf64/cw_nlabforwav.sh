...
#boundary=-b SIL
hmmdir2=clhmm
cmd="../htk/HTKTools/HVite -T 1 -y $tgtext.3 -l '*' $boundary -I nlab.mlf -m -o SW -C config -a -H $hmmdir/macros \
 -H $hmmdir/hmmdefs  -H $hmmdir2/hmmdefs_fix01 -l $tgtdir  \
  -S nlabalign.scp $dict $phonems"
echo $cmd; eval $cmd

cmd="../htk/HTKTools/HVite -T 1 -y $tgtext.mos -l '*' $boundary -I nlab.mlf -m -o S -C config -a -H $hmmdir/macros \
 -H $hmmdir/hmmdefs  -H $hmmdir2/hmmdefs_fix01 -l $tgtdir  \
  -S nlabalign.scp $dict $phonems"
echo $cmd; eval $cmd
